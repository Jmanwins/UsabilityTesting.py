...
def main(familiarity=None):
    st.title("Usability Testing Tool")

    home, consent, demographics, tasks, exit_tab, report_tab = st.tabs(
    ...
    with consent:
        ...
        consent_given = st.checkbox("I agree to participate in this usability test and consent to data collection.")
    ...
    with demographics:
        ...
        with st.form("demographic_form"):
            ...
            familiartity = st.selectbox("familiarity with similar tools", ["None", "Some", "Experienced"])
    ...
    with st.form("exit_form"):
        ...
        satisfaction = st.slider("How satisfied were you with the experience? ", 1,5,3)
    ...
    #this had an error about recognizing report_tab
    with report_tab:
